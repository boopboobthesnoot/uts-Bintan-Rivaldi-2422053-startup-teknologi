...
<div class="mt-6 flex flex-col space-y-4">
            ...
            <?php if (isset($component)) { $__componentOriginald411d1792bd6cc877d687758b753742c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald411d1792bd6cc877d687758b753742c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'w-full justify-center py-2.5 text-sm bg-blue-600 hover:bg-blue-700 active:bg-blue-800 focus:ring-blue-500 shadow-md shadow-blue-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('primary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full justify-center py-2.5 text-sm bg-blue-600 hover:bg-blue-700 active:bg-blue-800 focus:ring-blue-500 shadow-md shadow-blue-200']); ?>
                <?php echo e(__('Masuk Aplikasi')); ?>
...
<?php endif; ?>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-2 text-sm">
                <?php if(Route::has('password.request')): ?>
                    <a class="underline text-xs text-slate-400 hover:text-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('password.request')); ?>">
                ...
                <div class="text-xs text-slate-500">
                    Belum punya akun? 
                    <a class="font-bold text-blue-600 hover:text-blue-800 underline ml-1" href="<?php echo e(route('register')); ?>">
                        Daftar di sini
                    </a>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\startuptech\resources\views/auth/login.blade.php ENDPATH**/ ?>